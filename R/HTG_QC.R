...
#'
#' In addition to these plots, the function generates a Principal Component Analysis (PCA) plot and a violin plot of log-transformed counts, highlighting potential outlier samples. The function also creates a data frame including:
...
#'
#' The plots will be shown in the console and saved in the current working directory. The PCA plot and violin plot will be saved as separate PDF files.
#'
