...
#' @param count_data Count data matrix of gene expression.
#' @param col_data DataFrame containing sample metadata.
...
#'
#' @examples
#' HTG_convolution(outliers, pattern= "^NC-|^POS-|^GDNA-|^ERCC-",
#'                  count_data= counts_filtered, col_data= AnnotData, design_formula= "Ciclina2", remove_outliers = TRUE, dds = NULL)
#'
#' @name HTG_convolution
#'
HTG_convolution <- function(outliers, pattern = NULL, count_data, col_data, design_formula = NULL ,
